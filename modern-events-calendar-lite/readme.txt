...
* Google Calendar import, export, and synchronization settings
* Lithuanian-first interface
* English and Russian catalogs
* Private GitHub repository updates

== Removed ==
Booking, attendees, payments, WooCommerce, SMS, PDF invoices, unrelated importers, vendor promotions, and image-heavy skin previews are not shipped. Existing booking data is not deleted during upgrades.
