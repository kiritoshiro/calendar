...
class MEC_main extends MEC_base
{
    ...
    public function get_version()
    {
        ...
        // adventistai.lt: force every MEC asset URL (frontend.css, frontend.js,
        // etc) to change after a manual code edit, even on production where
        // WP_DEBUG is off. Without this, editing a file's *content* never
        // changes its enqueued *URL*, so browsers/CDNs/caching plugins that
        // key on URL keep serving the old cached copy indefinitely. Bump
        // this date string by hand after any future direct edit.
        $version .= '-magenda20260828b';
